  ...
  return (
    <>
      <header className="flex justify-start items-center py-6">
        <div className={`flex items-center space-x-4 ${isRTL ? 'ml-8' : 'ml-8'}`}>
        ...
        <nav className={`hidden md:flex items-center space-x-8 ${isRTL ? 'mr-6' : 'mr-6'}`}>
          <Link 
            to={isEnglishPage ? '/en' : '/'} 
          ...
          >
            <img 
              className={`w-10 h-10 p-1 ${isRTL ? 'mr-8' : 'ml-8'}`}
